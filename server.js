...
const corsOptions = {
    ...
    origin: function (origin, callback) {
        ...
        const allowListIndex = allowList.findIndex((url) =>
            url.includes(origin)
        )
...
// TODO - set dev db
const dbConnection = isTesting
    ? "mongodb://localhost/curtainCo_test"
    : process.env.MONGODB_URI || "mongodb://localhost/curtainCo"
